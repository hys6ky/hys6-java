...
public class Constant {
    ...
    public static final String _HYREN_JOB_NAME = "HYREN_JOB_NAME";

    public static final String _HYREN_S_DATE = "HYREN_S_DATE";

    public static final String _HYREN_E_DATE = "HYREN_E_DATE";

    public static final String _HYREN_MD5_VAL = "HYREN_MD5_VAL";

    public static final String _HYREN_OPER_DATE = "HYREN_OPER_DATE";

    public static final String _HYREN_OPER_TIME = "HYREN_OPER_TIME";

    public static final String _HYREN_OPER_PERSON = "HYREN_OPER_PERSON";

    public static final String MAXDATE = "99991231";

    public static final List<String> HYRENFIELD = new ArrayList<String>() {

        private static final long serialVersionUID = -5263415103875350525L;

        {
            ...
            add(_HYREN_E_DATE);
            add(_HYREN_MD5_VAL);
            add(_HYREN_OPER_DATE);
            add(_HYREN_OPER_TIME);
            add(_HYREN_OPER_PERSON);
        }
    };

    public static final String _VARCAHR_10 = "VARCHAR(10)";

    public static final String _VARCAHR_8 = "VARCHAR(8)";

    public static final String _VARCAHR_30 = "VARCHAR(30)";

    public static final String _VARCAHR_32 = "VARCHAR(32)";

    public static final String _VARCAHR_150 = "VARCHAR(150)";

    public static final String _VARCAHR_300 = "VARCHAR(300)";

    public static final String _MAX_DATE_10 = "9999-12-31";

    public static final String _DATE_TIME_FORMATTER_19 = "yyyy-MM-dd HH:mm:ss";

    public static final String _DATE_FORMATTER_10 = "yyyy-MM-dd";

    public static final String __PRINCIPAL = "--principal";

    public static final String __KEYTAB = "--keytab";

    public static final String _MAX_DATE_8 = "99991231";

    public static final String _DEFAULT_DATE_8 = "00000000";
    ...
    public static final String FTP_JOB_COMMAND = "ftp-job-command.sh";

    public static final String SEMISTRUCTURED_JOB_COMMAND = "semistructured-job-command.sh";

    public static final String UNSTRUCTURED_COLLECTION = "unstructured-job-command.sh";

    public static final String DISTRIBUTE_JOB_COMMAND = "distribution-job.sh";

    public static final String RECEIVE_JOB_COMMAND = "receive-job.sh";

    public static final String COLLECT_CDC_JOB_CONSUMER_COMMAND = "collect-cdc-job-consumer-command.sh";

    public static final String COLLECT_CDC_JOB_PRODUCER_COMMAND = "collect-cdc-job-producer-command.sh";
    ...
    public static final String STREAM_START_AGENT = "stream-agent-operation.sh";
    ...
    public static final String GATEWAY_CONTEXT_PATH = "/hyren-gateway";

    public static final String HIVE_DEFAULT_FIELD_TYPE = "STRING";
}

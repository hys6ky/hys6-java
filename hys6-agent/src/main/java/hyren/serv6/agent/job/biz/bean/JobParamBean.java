...
public class JobParamBean implements Serializable {
    ...
    public String toString() {
        return "JobParamBean [end_date=" + end_date + ", collect_set_id=" + collect_set_id + ", file_path=" + file_path + ", agent_time=" + agent_time + ", create_time=" + create_time + ", agent_id=" + agent_id + ", rely_job_id=" + rely_job_id + ", database_number=" + database_number + ", fre_month=" + fre_month + ", comp_id=" + comp_id + ", cf_jobnum=" + cf_jobnum + ", fre_week=" + fre_week + ", component=" + component + ", run_way=" + run_way + ", agent_date=" + agent_date + ", cf_id=" + cf_id + ", cron_expression=" + cron_expression + ", fre_day=" + fre_day + ", execute_time=" + execute_time + ", create_date=" + create_date + ", start_date=" + start_date + "]";
    }
}

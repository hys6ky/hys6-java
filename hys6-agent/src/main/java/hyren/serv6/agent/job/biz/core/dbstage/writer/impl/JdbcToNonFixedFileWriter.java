...
public class JdbcToNonFixedFileWriter extends AbstractFileWriter {
    ...
    public JdbcToNonFixedFileWriter(ResultSet resultSet, CollectTableBean collectTableBean, int pageNum, TableBean tableBean, DataExtractionDef dataExtractionDef) {
    ...
    public String writeFiles() {
        ...
        try {
            ...
            writer = writerFile.getBufferedWriter(DataBaseCode.ofValueByCode(dataExtractionDef.getDatabase_code()));
            ...
            log.info("========parseJson:{}=========", JsonUtil.toJson(parseJson));
            ...
            while (resultSet.next()) {
                ...
                for (int i = 0; i < numberOfColumns; i++) {
                    ...
                    if (!parseJson.isEmpty()) {
                        currValue = cl.cleanColumn(currValue, selectColumnList.get(i).toUpperCase(), typeList.get(i), FileFormat.FeiDingChang.getCode(), null, dataExtractionDef.getDatabase_code(), dataDelimiter);
                    }
                ...
                if (mergeIng != null && !mergeIng.isEmpty()) {
                    ...
                    String merge = allclean.merge(mergeIng, arrColString.toArray(new String[0]), selectColumnList.toArray(new String[0]), null, FileFormat.FeiDingChang.getCode(), dataExtractionDef.getDatabase_code(), dataDelimiter);

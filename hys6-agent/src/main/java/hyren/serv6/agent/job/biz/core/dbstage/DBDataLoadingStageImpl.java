...
public class DBDataLoadingStageImpl extends AbstractJobStage {
    ...
    public StageParamInfo handleStage(StageParamInfo stageParamInfo) {
        ...
        log.info("------------------表" + collectTableBean.getTable_name() + "数据库抽数加载阶段开始------------------");
        ...
        log.info("------------------表" + collectTableBean.getTable_name() + "数据库抽数加载阶段成功------------------执行时间为：" + (System.currentTimeMillis() - startTime) / 1000 + "，秒");

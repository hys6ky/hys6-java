...
function receive_main() {
    ...
    java -Xms64m -Xmx1024m ${HADOOP_OPTS} \
        ...
        ${DR_TASK_ID} ${CURR_BATH_DATE} ${SQL_PARAMS}
}

#function usage means how to use this script.
function usage(){
    # shellcheck disable=SC2016
    echo 'Usage: $0 DR_TASK_ID CURR_BATH_DATE SQL_PARAMS'
    # shellcheck disable=SC2016

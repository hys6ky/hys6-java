...
# 脚本运行入口
## 参数1  Agent 程序包名 hyren-serv6-agent-6.0.jar
...
function usage() {
  ...
  echo "for example: bash $0 hyren-serv6-agent-6.0.jar /agent_deploy_dir/hrsagent/sjkAgent_20099/running/running.log 32101 start"
  exit
}

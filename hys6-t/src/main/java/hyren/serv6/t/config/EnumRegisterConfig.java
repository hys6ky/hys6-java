...
import hyren.serv6.t.contants.PointTypeEnum;
import hyren.serv6.t.contants.ReqStatusEnum;
import hyren.serv6.t.contants.TaskStatusEnum;
import hyren.serv6.t.contants.TskCategoryEnum;
import lombok.Data;
...
public class EnumRegisterConfig {
    ...
    static {
        CodesItem.mapCat.put("TaskStatusEnum", TaskStatusEnum.class);
        CodesItem.mapCat.put("TskCategoryEnum", TskCategoryEnum.class);
        CodesItem.mapCat.put("ReqStatusEnum", ReqStatusEnum.class);
        CodesItem.mapCat.put("PointTypeEnum", PointTypeEnum.class);
    }

...
@Slf4j
@Service
public class MetaCollTask {

    private DatabaseWrapper remoteDb;

    private MetaEtlBean etlBean;

    private MetaObjInfoService objInfoService;

    private MetaSourceObjCacheService sourceObjCacheService;

    private MetaTaskService taskService;

    private MetaObjFuncService objFuncService;

    private MetaDataSourceService dataSourceService;
    ...
    private void saveProc(Long taskId) {
    ...
    private void saveMetaObjFunc(MetaSourceObjCache objCacheInfo, FunctionMeta functionMeta, String fmSql) {
    ...
    private void saveMeterView(Long taskId) {
    }

    private void saveTblMeta(Long taskId, MetaObjTypeEnum objType) {
        List<MetaSourceObjCache> objList = sourceObjCacheService.getMetaObjListByTaskId(taskId, etlBean.getLocalDb());
    ...
    private void checkColNmae(Set<String> metaColName, List<MetaObjTblCol> tblColList, DatabaseWrapper db) {
    ...
    private Map<String, Object> getMetaChangeInfo(Map<String, ColumnMetaVo> columnMetas, Set<String> primaryKeys, List<MetaObjTblCol> tblColList, MetaSourceObjCache objCacheInfo) {
    ...
    private void initMetaEtlBean(Long taskId) {
        etlBean = new MetaEtlBean();
        etlBean.setLocalDb(new DatabaseWrapper());
    ...
    public DatabaseSetVo getDslDatabaseSet(Long taskId) {

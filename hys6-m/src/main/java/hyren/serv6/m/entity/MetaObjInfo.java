...
@Table(tableName = "meta_obj_info")
public class MetaObjInfo extends TableEntity implements Serializable, Cloneable {

    private static final long serialVersionUID = 321566870187324L;

    private transient static final Set<String> __PrimaryKeys;

    public static final String TableName = "meta_obj_info";
    ...
    @NotBlank(message = "", groups = MetaObjInfoSaveVo.Default.class)
    private String en_name;

    @ApiModelProperty(name = "中文名", notes = "", dataType = "String", required = true)
    @Size(min = 1, max = 100, message = "")
    @NotBlank(message = "", groups = { MetaObjInfoSaveVo.Edit.class, MetaObjInfoSaveVo.Default.class })

...
import hyren.serv6.m.util.dbConf.bean.DBConnectionProp;
...
public enum DataBaseType {
    ...
    Oracle10("Oracle10") {
        ...
        public List<String> getExternalTableKeys() {
            return new ArrayList<>(Arrays.asList(StorageTypeKeyV2.database_driver, StorageTypeKeyV2.jdbc_url, StorageTypeKeyV2.user_name, StorageTypeKeyV2.database_pwd, StorageTypeKeyV2.database_type, StorageTypeKeyV2.database_name, StorageTypeKeyV2.sftp_host, StorageTypeKeyV2.sftp_port, StorageTypeKeyV2.sftp_pwd, StorageTypeKeyV2.sftp_user, StorageTypeKeyV2.external_root_path, StorageTypeKeyV2.database_code, StorageTypeKeyV2.external_directory));
        }
    }
    ,
    ORACLE9I("ORACLE9I") {
    ...
    Postgresql("Postgresql") {
        ...
        @Override
        public List<String> getExternalTableKeys() {
            return new ArrayList<>(Arrays.asList(StorageTypeKeyV2.database_driver, StorageTypeKeyV2.jdbc_url, StorageTypeKeyV2.user_name, StorageTypeKeyV2.database_pwd, StorageTypeKeyV2.database_type, StorageTypeKeyV2.database_name, StorageTypeKeyV2.sftp_host, StorageTypeKeyV2.sftp_port, StorageTypeKeyV2.sftp_pwd, StorageTypeKeyV2.sftp_user, StorageTypeKeyV2.external_root_path, StorageTypeKeyV2.database_code));
        }
    }
    ,
    GBase("GBase") {

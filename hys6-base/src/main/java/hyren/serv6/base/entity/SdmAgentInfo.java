...
@Data
@ApiModel("流数据管理Agent信息表")
@Table(tableName = "sdm_agent_info")
public class SdmAgentInfo extends ProEntity {
    ...
    @NotBlank(message = "")
    protected String sdm_agent_status;

    @ApiModelProperty(value = "", required = true)
    @Size(min = 1, max = 512, message = "")
    @NotBlank(message = "")
    protected String sdm_agent_name;
    ...
    @Size(min = 1, max = 1, message = "")
    @NotBlank(message = "")
    protected String sdm_agent_type;

    @ApiModelProperty(value = "", required = true)
    @Size(min = 1, max = 50, message = "")
    @NotBlank(message = "")
    protected String sdm_agent_ip;

    @ApiModelProperty(value = "", required = true)
    @Size(min = 1, max = 10, message = "")
    @NotBlank(message = "")
    protected String sdm_agent_port;

...
@Data
@ApiModel("加工作业表信息表-")
@Table(tableName = "dm_job_table_info")
public class DmJobTableInfo extends ProEntity {

    private static final long serialVersionUID = 321566870187324L;

    private transient static final Set<String> __PrimaryKeys;

    public static final String TableName = "dm_job_table_info";
    ...
    @ApiModelProperty(value = "", required = true)
    protected String jobtab_en_name;

    @ApiModelProperty(value = "", required = true)
    protected String jobtab_cn_name;

    @ApiModelProperty(value = "", required = true)
    protected Integer jobtab_step_number;

    @ApiModelProperty(value = "", required = false)
    protected String jobtab_is_temp;

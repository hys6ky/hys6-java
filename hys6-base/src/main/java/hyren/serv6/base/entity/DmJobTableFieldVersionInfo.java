...
@Data
@ApiModel("加工作业表字段版本表")
@Table(tableName = "dm_job_table_field_version_info")
public class DmJobTableFieldVersionInfo extends ProEntity {

    private static final long serialVersionUID = 321566870187324L;

    private transient static final Set<String> __PrimaryKeys;

    public static final String TableName = "dm_job_table_field_version_info";
    ...
    static {
        ...
        __tmpPKS.add("jobtab_field_version_id");
    ...
    @ApiModelProperty(value = "", required = true)
    protected Long jobtab_field_version_id;
    ...
    public void setJobtab_field_version_id(String jobtab_field_version_id) {
        if (fd.ng.core.utils.StringUtil.isNotBlank(jobtab_field_version_id)) {
            this.jobtab_field_version_id = new Long(jobtab_field_version_id);
        }
    }

    public void setJobtab_field_version_id(Long jobtab_field_version_id) {
        this.jobtab_field_version_id = jobtab_field_version_id;
    }

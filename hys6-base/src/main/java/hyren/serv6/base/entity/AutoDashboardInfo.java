...
public class AutoDashboardInfo extends ProEntity {
    ...
    @NotBlank(message = "")
    protected String dashboard_name;

    @ApiModelProperty(value = "", required = false)
    protected String dashboard_desc;
    ...
    @ApiModelProperty(value = "", required = false)
    protected String dashboard_theme;

    @ApiModelProperty(value = "", required = false)
    protected String border_width;

    @ApiModelProperty(value = "", required = false)
    protected String border_height;

    @ApiModelProperty(value = "", required = true)
    @Size(min = 1, max = 1, message = "")
    @NotBlank(message = "")
    protected String dashboard_status;

    @ApiModelProperty(value = "", required = false)
    protected String dashboard_widget;

    public void setDashboard_id(String dashboard_id) {
        if (fd.ng.core.utils.StringUtil.isNotBlank(dashboard_id)) {

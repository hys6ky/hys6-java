...
@Data
@ApiModel("加工模型表字段信息")
@Table(tableName = "dm_module_table_field_info")
public class DmModuleTableFieldInfo extends ProEntity {

    private static final long serialVersionUID = 321566870187324L;

    private transient static final Set<String> __PrimaryKeys;

    public static final String TableName = "dm_module_table_field_info";

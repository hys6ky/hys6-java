...
public class SourceFileAttribute extends ProEntity {
    ...
    @NotBlank(message = "")
    protected String is_in_hbase;

    @ApiModelProperty(value = "", required = true)
    protected Long seqencing;
    ...
    public void setSeqencing(String seqencing) {
        if (fd.ng.core.utils.StringUtil.isNotBlank(seqencing)) {

...
public class SysRecover extends ProEntity {
    ...
    protected Long re_id;

    @ApiModelProperty(value = "", required = true)
    protected String re_date;

    @ApiModelProperty(value = "", required = true)
    protected String re_time;
    ...
    public void setRe_id(String re_id) {
        if (fd.ng.core.utils.StringUtil.isNotBlank(re_id)) {

...
public class ComponentInfo extends ProEntity {
    ...
    @NotBlank(message = "")
    protected String comp_version;

    @ApiModelProperty(value = "", required = false)
    protected String icon_info;

    @ApiModelProperty(value = "", required = false)
    protected String color_info;

    @ApiModelProperty(value = "", required = true)
    protected String comp_type;

    @ApiModelProperty(value = "", required = false)
    protected String comp_remark;
}

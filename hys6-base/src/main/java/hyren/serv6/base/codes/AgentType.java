...
public enum AgentType {
    ...
    WenBenLiu("6", "文本流Agent", "35", "Agent类别"),
    XiaoXiLiu("7", "消息流Agent", "35", "Agent类别");
    ...
    public static String ofValueByCode(String code) {
        ...
        throw new SystemRuntimeException("根据[" + code + "]没有找到对应的代码项[AgentType:Agent类别]");
    }
    ...
    public static String getCodeByValue(String value) {
        ...
        throw new SystemRuntimeException("根据[" + value + "]没有找到对应的代码项[AgentType:Agent类别]");
    }

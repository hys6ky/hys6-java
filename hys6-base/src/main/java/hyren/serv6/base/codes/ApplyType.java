...
public enum ApplyType {
    ...
    ChaKan("1", "查看", "57", "数据申请类型"), XiaZai("2", "下载", "57", "数据申请类型"), FaBu("3", "发布", "57", "数据申请类型"), ChongMingMing("4", "重命名", "57", "数据申请类型");
    ...
    public static String ofValueByCode(String code) {
        ...
        throw new SystemRuntimeException("根据[" + code + "]没有找到对应的代码项[ApplyType:数据申请类型]");
    }
    ...
    public static String getCodeByValue(String value) {
        ...
        throw new SystemRuntimeException("根据[" + value + "]没有找到对应的代码项[ApplyType:数据申请类型]");
    }

...
public enum TableLifeCycle {
    ...
    YongJiu("1", "永久", "85", "数据表生命周期"), LinShi("2", "临时", "85", "数据表生命周期");
    ...
    public static String ofValueByCode(String code) {
        ...
        throw new SystemRuntimeException("根据[" + code + "]没有找到对应的代码项[TableLifeCycle:数据表生命周期]");
    }
    ...
    public static String getCodeByValue(String value) {
        ...
        throw new SystemRuntimeException("根据[" + value + "]没有找到对应的代码项[TableLifeCycle:数据表生命周期]");
    }

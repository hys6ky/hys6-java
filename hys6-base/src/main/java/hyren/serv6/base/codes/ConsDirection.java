...
public enum ConsDirection {
    ...
    NeiBu("1", "内部", "131", "消费方向"), WaiBu("2", "外部", "131", "消费方向");
    ...
    public static String ofValueByCode(String code) {
        ...
        throw new SystemRuntimeException("根据[" + code + "]没有找到对应的代码项[ConsDirection:消费方向]");
    }
    ...
    public static String getCodeByValue(String value) {
        ...
        throw new SystemRuntimeException("根据[" + value + "]没有找到对应的代码项[ConsDirection:消费方向]");
    }

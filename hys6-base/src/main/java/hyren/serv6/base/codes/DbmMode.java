...
public enum DbmMode {
    ...
    ShuJuDuiBiao("1", "数据对标", "68", "对标方式"), BiaoJieGouDuiBiao("2", "表结构对标", "68", "对标方式");
    ...
    public static String ofValueByCode(String code) {
        ...
        throw new SystemRuntimeException("根据[" + code + "]没有找到对应的代码项[DbmMode:对标方式]");
    }
    ...
    public static String getCodeByValue(String value) {
        ...
        throw new SystemRuntimeException("根据[" + value + "]没有找到对应的代码项[DbmMode:对标方式]");
    }

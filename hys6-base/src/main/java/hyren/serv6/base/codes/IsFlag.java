...
public enum IsFlag {
    ...
    Shi("1", "是", "18", "是否标识"), Fou("0", "否", "18", "是否标识");
    ...
    public static String ofValueByCode(String code) {
        ...
        throw new SystemRuntimeException("根据[" + code + "]没有找到对应的代码项[IsFlag:是否标识]");
    }
    ...
    public static String getCodeByValue(String value) {
        ...
        throw new SystemRuntimeException("根据[" + value + "]没有找到对应的代码项[IsFlag:是否标识]");
    }

...
public enum SdmPatitionWay {
    ...
    SuiJiFenBu("1", "随机分布", "126", "流数据管理分区方式"), Key("2", "key", "126", "流数据管理分区方式"), FenQu("3", "分区", "126", "流数据管理分区方式");
    ...
    public static String ofValueByCode(String code) {
        ...
        throw new SystemRuntimeException("根据[" + code + "]没有找到对应的代码项[SdmPatitionWay:流数据管理分区方式]");
    }
    ...
    public static String getCodeByValue(String value) {
        ...
        throw new SystemRuntimeException("根据[" + value + "]没有找到对应的代码项[SdmPatitionWay:流数据管理分区方式]");
    }

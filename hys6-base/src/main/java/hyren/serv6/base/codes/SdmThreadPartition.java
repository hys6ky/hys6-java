...
public enum SdmThreadPartition {
    ...
    YiDuiYi("1", "一对一", "130", "流数据管理线程与分区的关系"), YiDuiDuo("2", "一对多", "130", "流数据管理线程与分区的关系");
    ...
    public static String ofValueByCode(String code) {
        ...
        throw new SystemRuntimeException("根据[" + code + "]没有找到对应的代码项[SdmThreadPartition:流数据管理线程与分区的关系]");
    }
    ...
    public static String getCodeByValue(String value) {
        ...
        throw new SystemRuntimeException("根据[" + value + "]没有找到对应的代码项[SdmThreadPartition:流数据管理线程与分区的关系]");
    }

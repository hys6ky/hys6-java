...
public enum ReduceScope {
    ...
    QuanKuYaSuo("1", "全库压缩", "38", "压缩范围"), AnBiaoYaSuo("2", "按表压缩", "38", "压缩范围");
    ...
    public static String ofValueByCode(String code) {
        ...
        throw new SystemRuntimeException("根据[" + code + "]没有找到对应的代码项[ReduceScope:压缩范围]");
    }
    ...
    public static String getCodeByValue(String value) {
        ...
        throw new SystemRuntimeException("根据[" + value + "]没有找到对应的代码项[ReduceScope:压缩范围]");
    }

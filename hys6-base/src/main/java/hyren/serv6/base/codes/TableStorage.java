...
public enum TableStorage {
    ...
    ShuJuBiao("0", "数据表", "86", "数据表存储方式"), ShuJuShiTu("1", "数据视图", "86", "数据表存储方式");
    ...
    public static String ofValueByCode(String code) {
        ...
        throw new SystemRuntimeException("根据[" + code + "]没有找到对应的代码项[TableStorage:数据表存储方式]");
    }
    ...
    public static String getCodeByValue(String value) {
        ...
        throw new SystemRuntimeException("根据[" + value + "]没有找到对应的代码项[TableStorage:数据表存储方式]");
    }

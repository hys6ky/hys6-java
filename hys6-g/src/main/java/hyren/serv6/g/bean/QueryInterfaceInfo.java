...
@DocClass(desc = "", author = "dhw", createdate = "2020/3/30 16:12")
@Table(tableName = "query_interface_info")
public class QueryInterfaceInfo extends ProEntity {

    private static final long serialVersionUID = 321566870187324L;

    public static final String TableName = "query_interface_info";

    @DocBean(name = "token", value = "", dataType = String.class, required = true)
    private String token;

    @DocBean(name = "user_id", value = "", dataType = Long.class, required = true)
    private Long user_id;

    @DocBean(name = "user_password", value = "", dataType = String.class, required = true)
    private String user_password;

    @DocBean(name = "user_name", value = "", dataType = String.class, required = true)
    private String user_name;

    @DocBean(name = "url", value = "", dataType = String.class, required = true)
    private String url;

    @DocBean(name = "start_use_date", value = "", dataType = String.class, required = true)
    private String start_use_date;

    @DocBean(name = "use_valid_date", value = "", dataType = String.class, required = true)
    private String use_valid_date;

    @DocBean(name = "use_state", value = "", dataType = String.class, required = true)
    private String use_state;

    @DocBean(name = "sysreg_name", value = "", dataType = String.class, required = true)
    ...
    @DocBean(name = "table_type_name", value = "", dataType = String.class, required = true)
    private String table_type_name;

    @DocBean(name = "original_name", value = "", dataType = String.class, required = true)
    private String original_name;

    @DocBean(name = "table_blsystem", value = "", dataType = String.class, required = true)
    private String table_blsystem;

    @DocBean(name = "interface_name", value = "", dataType = String.class, required = true)
    private String interface_name;

    @DocBean(name = "interface_id", value = "", dataType = String.class, required = true)
    private String interface_id;

    @DocBean(name = "use_id", value = "", dataType = String.class, required = true)
    private String use_id;

    @DocBean(name = "interface_use_id", value = "", dataType = String.class, required = true)

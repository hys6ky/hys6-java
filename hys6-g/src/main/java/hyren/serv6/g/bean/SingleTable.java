...
public class SingleTable extends ProEntity {

    private static final long serialVersionUID = 321566870187324L;

    public static final String TableName = "single_table";

    @DocBean(name = "tableName", value = "", dataType = String.class, required = false)
    private String tableName;

    @DocBean(name = "whereColumn", value = "", dataType = String.class, required = false)
    private String whereColumn;

    @DocBean(name = "selectColumn", value = "", dataType = String.class, required = false)
    private String selectColumn;

    @DocBean(name = "num", value = "", dataType = Integer.class, required = false)
    private Integer num;

    @DocBean(name = "dataType", value = "", dataType = Integer.class, required = false)

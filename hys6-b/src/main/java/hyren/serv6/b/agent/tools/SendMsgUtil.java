...
public class SendMsgUtil {
    ...
    @Param(name = "databaseInfo", desc = "", range = "")
    @Return(desc = "", range = "")
    private static DatabaseSet getLegalParam(Map<String, Object> databaseInfo) {
        ...
        String size = databaseInfo.get("fetch_size") == null ? "" : String.valueOf(databaseInfo.get("fetch_size"));
        return databaseSet;
    }

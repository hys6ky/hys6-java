package agent.datafileconf.tableconf;
...
public class TableconfTest {
    ...
    public void getTableData() {
        try {
            URL url = new URL("http://localhost:20003/B/tableconf/getTableData");
    ...
    @Test
    public void getTableColumnByTableId() {
        try {
            URL url = new URL("http://localhost:20003/B/tableconf/getTableColumnByTableId");
            HttpURLConnection connection = (HttpURLConnection) url.openConnection();
            connection.setRequestMethod("POST");
            connection.setDoOutput(true);
            connection.setRequestProperty("HyrenAuthedForBizpotOnlineUserinfo", "");
            connection.setRequestProperty("User-Agent", "Mozilla/5.0");
            String params = "colSetId=976483279622377472&table_id=1";
            OutputStream outputStream = connection.getOutputStream();
            outputStream.write(params.getBytes());
            outputStream.flush();
            outputStream.close();
    ...
    public void getTableColumnByTableName() {
        try {
            URL url = new URL("http://localhost:20003/B/tableconf/getTableColumnByTableName");
            HttpURLConnection connection = (HttpURLConnection) url.openConnection();
            connection.setRequestMethod("POST");
            connection.setDoOutput(true);
            connection.setRequestProperty("HyrenAuthedForBizpotOnlineUserinfo", "");

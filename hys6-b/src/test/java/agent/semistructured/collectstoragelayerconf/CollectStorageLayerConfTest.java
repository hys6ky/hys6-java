package agent.semistructured.collectstoragelayerconf;
...
public class CollectStorageLayerConfTest {
    ...
    public void getCollectStorageLayerInfo() {
        try {
            String re_url = "http://127.0.0.1:20003/B/collectstoragelayerconf/getCollectStorageLayerInfo?odc_id=" + 1062419609564483584L;
    ...
    public void getStorageLayerDestById() {
        try {
            String re_url = "http://127.0.0.1:20003/B/collectstoragelayerconf/getStorageLayerDestById?ocs_id=" + 1062394296906289152L;
            URL url = new URL(re_url);
            HttpURLConnection connection = (HttpURLConnection) url.openConnection();
            connection.setRequestMethod("POST");
            connection.setRequestProperty("User-Agent", "Mozilla/5.0");
    ...
    public void getStorageLayerAttrById() {
        try {
            String re_url = "http://127.0.0.1:20003/B/collectstoragelayerconf/getStorageLayerAttrById?dsl_id=" + 1001872065671725056L;
            URL url = new URL(re_url);
            HttpURLConnection connection = (HttpURLConnection) url.openConnection();
            connection.setRequestMethod("POST");
            connection.setRequestProperty("User-Agent", "Mozilla/5.0");
    ...
    public void getColumnStorageLayerInfo() {
        try {
            String re_url = "http://127.0.0.1:20003/B/collectstoragelayerconf/getColumnStorageLayerInfo?dsl_id=" + 1001872065671725056L + "&ocs_id=" + 1062394296906289152L;
            URL url = new URL(re_url);
            HttpURLConnection connection = (HttpURLConnection) url.openConnection();
            connection.setRequestMethod("POST");
            connection.setRequestProperty("User-Agent", "Mozilla/5.0");
    ...
    public void searchDataStore() {
        try {
            String re_url = "http://127.0.0.1:20003/B/collectstoragelayerconf/searchDataStore";
            URL url = new URL(re_url);
            HttpURLConnection connection = (HttpURLConnection) url.openConnection();
            connection.setRequestMethod("POST");
            connection.setRequestProperty("User-Agent", "Mozilla/5.0");

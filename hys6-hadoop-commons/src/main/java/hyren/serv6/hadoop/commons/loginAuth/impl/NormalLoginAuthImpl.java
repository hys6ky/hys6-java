...
@Slf4j
public class NormalLoginAuthImpl extends AbsLoginAuthImpl {
    ...
    public NormalLoginAuthImpl(String conf_dir) {
        ...
        log.info("platform: normal, go to the default configuration file!");
    }

    public NormalLoginAuthImpl(Configuration conf) {
        configuration = conf;
        log.info("platform: normal, go to the customize configuration file!");
    }

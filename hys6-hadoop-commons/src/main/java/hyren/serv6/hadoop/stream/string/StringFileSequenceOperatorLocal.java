...
@Slf4j
public class StringFileSequenceOperatorLocal<T> implements ConsumerBusinessProcess<T> {
    ...
    public StringFileSequenceOperatorLocal(Map<String, Object> jsonStore) throws Exception {

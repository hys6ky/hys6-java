...
public class ProducerOperatorString {
    ...
    public JobParamsEntity getMapParam(Map<String, Object> json) {
        ...
        try {
            ...
            String header = null;
            if (msgtypeJson.get("header") != null) {
            ...
            if (businessJson.get("sdm_bus_pro_cla") != null) {
                sdm_bus_pro_cla = String.valueOf(businessJson.get("sdm_bus_pro_cla"));
            }
            ...
            if (!StringUtil.isBlank(interceptor)) {
            ...
            jobParams.setSync(String.valueOf(jb.get("sync")));
            log.info("ProducerOperatorString------------------------KafkaProducerWorker加载配置文件！！！");
        } catch (Exception e) {
            if (e instanceof BusinessException) {
                throw new BusinessException(e.getMessage());
            }
            log.error("ProducerOperatorString-------------------------生产者参数获取失败！！！", e);
        }

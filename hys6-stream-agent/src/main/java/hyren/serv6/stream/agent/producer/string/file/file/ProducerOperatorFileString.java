        ...
        try {
            ...
            for (Object columnParam : columesJson) {
                ...
                if (null != columnJson.get("num")) {
                    num = columnJson.get("num").toString();
                }
                ...
                listColumn.add(Integer.parseInt(num) - 1, cloumeName + "`" + sdm_is_send);
            }
            ...
            log.info("ProducerOperatorFileString-------------------KafkaProducerWorker加载配置文件！！！");
        } catch (Exception e) {
